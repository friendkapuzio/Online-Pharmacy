...
public class EditProductCommand extends AbstractCommand {
    ...
    public Router execute(SessionRequestContent content) {
        ...
        try {
            ...
            String isAdd = content.getFirstParameterValue(IS_ADD);
            String addedAmount = content.getFirstParameterValue(ADDED_AMOUNT);
            ...
            EnumSet<ProductOperationError> errors =
                    new ProductLogic().addQuantityUpdate(id, name, price, isAdd, addedAmount, form, formDescription, isPrescriptionRequired, isDeleted);
            if (errors.isEmpty()) {
                ...
                content.putRequestAttribute(IS_ADD, isAdd);
                content.putRequestAttribute(ADDED_AMOUNT, addedAmount);
